...
st.write("- Evolution of rock styles since its birth in the 1960s.")
...
st.write("- In which regions and cities are certain styles more predominant?")
st.write("- Which are best artists and albums from a specific region/state?")
st.write("- Analysis of album and song lengths by style.")
st.write(" ")
